...
describe("Staking", function () {
  ...
  describe("Errors", function () {
    ...
    it('Zero Address Check', async () => {
      ...
      await expect(stakingReward.changeMCGR(addressZero)).to.be.revertedWith(errorMsg);
      await expect(stakingReward.changeNRGS(addressZero)).to.be.revertedWith(errorMsg);
    });
